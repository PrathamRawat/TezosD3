...
const seperateAxisDynamicHistogramGenerator = function(height, barWidth, graphSVGElement, axisSVGElement, queryResult, xAxisKey, yAxisKey, axisWidth= 100, barColor = "black") {
    ...
    bar.append("rect")
        .attr("fill", barColor)
        .attr("width", xScale.bandwidth()) // Sets a padding of one pixel between bars
        .attr("height", yScale);
